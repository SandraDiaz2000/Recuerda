            ...
            <div class="card h-100">
              ...
              <div class="card h-100">
                ...
                <div class="col-lg-4 mb-4">
                    ...
                    <div class="card-body" style="background-color: #125e39;">
                        <h5 class="card-title text-white">San Francisco</h5>
                        <p class="card-text text-white" style="text-align: justify;">
                        Fundada en 1692...
                    <p class="text-center"class="text-center"><a class="btn " href="{{ url('/Haciendas/Francisco') }}" role="button" style="background: white;">Ver más &raquo;</a></p>
